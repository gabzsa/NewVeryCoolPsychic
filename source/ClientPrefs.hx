...
class ClientPrefs {
	...
	public static var uproarParticles:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.uproarParticles = uproarParticles;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.uproarParticles != null) {
			uproarParticles = FlxG.save.data.uproarParticles;
		}
